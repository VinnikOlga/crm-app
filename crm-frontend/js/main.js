(function () {
  ...
  // Элементы для иконок списка контактов
  ...
  function createModalWindow(client, modalWindowStructure) {
    ...
    if (typeOfModal !== 'delete') {
      ...
      // Переключатель активна/неактивна кнопка "Добавить контакт"
      ...
      // Переключатель активна/неактивна кнопка "Удалить контакт" при условии наличия данных в инпуте 
  ...
  // Блок с выводом ошибок и др. инфорации
